...
class PlaySlabEffectAction {
     ...
     */
    static apply(state: GameState | GameStateView, move: PlaySlabEffect): void {
            ...
            if (frog) {
                ...
                switch (slab.front) {
                    ...
                    case SlabFrontType.RED_MALE:
                        this.mayProduceFrogBirth(player!, MaleFrog.Red, frog)
                        break;
                    case SlabFrontType.BLUE_MALE:
                        this.mayProduceFrogBirth(player!, MaleFrog.Blue, frog)
                        break;
                    case SlabFrontType.YELLOW_MALE:
                        this.mayProduceFrogBirth(player!, MaleFrog.Yellow, frog)
                        break;
                    case SlabFrontType.GREEN_MALE:
                        this.mayProduceFrogBirth(player!, MaleFrog.Green, frog)
                        break;
                    case SlabFrontType.PURPLE_MALE:
                        this.mayProduceFrogBirth(player!, MaleFrog.Purple, frog)
                        break;
                    case SlabFrontType.PINK_MALE:
                        this.mayProduceFrogBirth(player!, MaleFrog.Pink, frog)
                        break;
                }
     ...
     */
    static mayProduceFrogBirth(player: Player, male: MaleFrog, frog: FemaleFrog) {
